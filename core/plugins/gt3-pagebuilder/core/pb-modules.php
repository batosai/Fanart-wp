...
/*$modules['portfolio_masonry']['name'] = "portfolio_masonry";
$modules['portfolio_masonry']['caption'] = "Portfolio Masonry";
$modules['portfolio_masonry']['help'] = __("Add non-ajax portfolio to the page.", "gt3_builder");*/
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont diagram_admin'>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Background', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_bg]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg'] : 'cfd1d1')) . "</div>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Color', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color'] : '40b7b8')) . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Width:', 'gt3_builder'), "bar_width", "95px", "left", "2px") . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Size:', 'gt3_builder'), "diagram_size", "95px", "left", "62px") . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Font Size:', 'gt3_builder'), "percent_size", "95px", "left", "16px") . "</div>
		<div class='clear'></div>
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_select_with_caption($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Thumbs format preview', 'gt3_builder'), "preview_thumbs_format", "100px", array("rectangle" => "Rectangle", "square" => "Square")) . "
...
<div class='pop_scrollable_area'>
    <div class='padding-cont'>
        ...
        <div class='bg_start_style'>" . get_module_settings_part_select_with_caption($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Properties", "gt3_builder"), "properties", "200px", array("stretch" => "Stretch", "" => "Pattern", "paralax" => "Paralax")) . "</div>
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
		...
		" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Counter text", "gt3_builder"), "stat_text", "100%", "left") . "
        " . get_module_settings_part_padding_bottom($gt3_theme_pagebuilder, $moduleid) . "
        <div class='clear'></div>
    </div>
    " . get_module_settings_part_done_btn() . "
