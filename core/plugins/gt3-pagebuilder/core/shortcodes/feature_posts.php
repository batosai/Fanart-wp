        ...
        ';
            ...
            while ($wp_query->have_posts()) : $wp_query->the_post();
                ...
                if (strlen($featured_image[0]) > 0) {
                    ...
                    $featured_image_full = '<div class="img_block wrapped_img"><a href="' . get_permalink(get_the_ID()) . '"><img alt="" src="' . $featured_image_url . '" /><div class="featured_item_fadder"></div><span  class="gallery_ico"><i class="stand_icon icon-eye"></i></span></a></div>';
                } else {
                    $featured_image_full = '';
                }
									   ...
									   ' . $post_excerpt . '
										...
										<div class="featured_items_meta">
											<div class="preview_categ">
												<span class="preview_meta_data">'.__('in', 'theme_localization') . ' '. trim($post_categ, ', ') . '</span>
												<span class="preview_meta_comments"><a href="' . get_comments_link() . '">' . get_comments_number(get_the_ID()) .' '. __('comments', 'theme_localization') .'</a></span>
											</div>
