...
?>
    ...
    <?php } else { ?>
        function get_works() {
            ...
            gt3_get_blog_posts("post", <?php gt3_the_theme_option('fw_port_per_page'); ?>, posts_already_showed, "port_massonry_template", ".fs_blog_module" <?php echo (isset($selected_categories) && strlen($selected_categories)>0 ? ', "' . $selected_categories.'"' : ",0") ?>, <?php echo $curauth->ID; ?>);
            posts_already_showed = posts_already_showed + <?php gt3_the_theme_option('fw_port_per_page'); ?>;
        }
        jQuery(document).ready(function () {
